package com.dp.Spring_web_thymeleaf.controller;


import com.dp.Spring_web_thymeleaf.model.Product;
import com.dp.Spring_web_thymeleaf.model.ProductType;
import com.dp.Spring_web_thymeleaf.repository.ProductRepository;
...
public class ProductController {
    ...
    public String editProduct(@PathVariable Long id, Model model){
        Product product = productRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("Invalid product id: " + id));        model.addAttribute("product",product);
        model.addAttribute("types", ProductType.values());
